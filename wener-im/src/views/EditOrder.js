...
const EditOrder = () => {
  ...
  const [paymentMethods, setPaymentMethods] = useState(['Bkash', 'Cheque', 'Cash', 'Mobile banking'])
  ...
  async function handleInvoiceCreation(e) {
    ...
    if(createDate && invoiceID){
      ...
      const { data, error } = await supabase
        .from('order_events')
        .insert([
          { name: 'OrderApprovedByIM', created_by: profile.id, data: eventData },
        ])
                  ...
                  <Col>
                    <Form>
                      <Row form>
                        <Col md="12" className="form-group">
                          ...
                          >
                            {distributorList ? distributorList.map(distributor => (
                              <option key={distributor.id} value={distributor.id}>{distributor.business_name}</option>
                            )) : null}
                          </FormSelect>
                        </Col>
                        ...
                        <Row>
                          <Col md="12" className="form-group">
                          <label htmlFor="feInputState">Choose Payment Method</label>
                          <FormSelect
                            id="feInputState"
                            value={paymentMethod}
                            onChange={(e) => {
                          ...
                          >
                            {paymentMethods ? paymentMethods.map(thisPaymentMethod => (
                              <option key = {thisPaymentMethod} value={thisPaymentMethod}>{thisPaymentMethod}</option>
                            )) : null}
                          </FormSelect>
                          </Col>
                          <Col md="12" className="form-group">
                        ...
                        <Col sm={6} className="form-group">
                          <label htmlFor="feInputZip">Credit: {
                            credit > creditLimit?
                      ...
                      <Row form className='mt-1' style={{ alignItems: 'flex-end' }}>
                                ...
                                <Col md="4"
                                  ...
                                  <FormInput
                                    ...
                                    onChange = {(e) => {
                                      ...
                                      setDiscountAmount((discountPercentage/100)*e.target.value*unitPrice)
                                ...
                                <Col md="3" sm={4} xs={5} className="form-group">
                                  ...
                                  <FormInput
                                    ...
                                    onChange = {(e) => {
                                      ...
                                      setDiscountAmount((discountPercentage/100)*quantity*e.target.value)
                                ...
                                <Col md="3" sm={4} xs={5} className="form-group">
                                  ...
                                  <FormInput
                                    ...
                                    onChange = {(e) => {
                                      ...
                                      setDiscountAmount((e.target.value/100)*quantity*unitPrice)
                        ...
                        {/* Mapping of Invoice data */
                          ...
                          return (      
                            ...
                            <Col md="5"
                              ...
                              <FormInput
                                ...
                                value = {invoiceItems[index].editing? editProductName : invoiceItems[index].product_name}
                            ...
                            <Col md="4"
                              ...
                              <FormInput
                                id="feInputZip"
                                className = "quantity"
                                value = {invoiceItems[index].editing? editQuantity : invoiceItems[index].quantity}
                                onChange = {(e) => {
                                      setEditQuantity(e.target.value)
                                      setEditDiscountAmount((editDiscountPercentage/100)*e.target.value*editUnitPrice)
                                      setEditTotalAmount(e.target.value*editUnitPrice)}
                                }
                                disabled = {invoiceItems[index].editing? false : true}
                              />
                            </Col>
                            ...
                            <Col md="3" sm={4} xs={5} className="form-group">
                              ...
                              <FormInput
                                ...
                                id="feInputZip"
                                value = {invoiceItems[index].editing? editUnitPrice: invoiceItems[index].rate}
                                onChange = {(e) => {
                                  setEditUnitPrice(e.target.value)
                                  setEditDiscountAmount((editDiscountPercentage/100)*editQuantity*e.target.value)
                                  setEditTotalAmount(editQuantity*e.target.value)}}
                                disabled = {invoiceItems[index].editing? false : true}
                              />
                            </Col>
                            ...
                            <Col md="3" sm={4} xs={5} className="form-group">
                              ...
                              <FormInput
                                ...
                                id="feInputZip"
                                type='number'
                                value = {invoiceItems[index].editing? editDiscountPercentage : invoiceItems[index].discount_percentage}
                                onChange = {(e) => {
                                  setEditDiscountPercentage(e.target.value)
                                  setEditDiscountAmount((e.target.value/100)*editQuantity*editUnitPrice)
                                  setEditTotalAmount(editQuantity*editUnitPrice)
                                }}
                                disabled = {invoiceItems[index].editing? false : true}
                              />
                            </Col>
                            ...
                            <Col md="3" sm={4} xs={5} className="form-group">
                              ...
                              <FormInput
                                id="feInputZip"
                                placeholder = {invoiceItems[index].editing? editDiscountAmount : invoiceItems[index].discount_amount}
                                disabled
                              />
                            </Col>
                            ...
                            <Col md="4" sm={4} xs={5} className="form-group">
                              ...
                              <FormInput
                                id="feInputZip"
                                disabled
                                placeholder = {invoiceItems[index].editing? editTotalAmount : invoiceItems[index].total_amount}
                              />
                            </Col>
                          ...
                          <Button style = {{marginBottom: 17, marginLeft: 5}} onClick = {(e) => {
                            setUpdateMessage(false)
                            if(!editing){
                              e.preventDefault()
                              setEditing(true)
                      ...
                      {updateMessage?<h6 style = {{color: '#00cc00'}}>Updated</h6>:<h6 style = {{color: '#f2000d'}}>Not Updated</h6>}
                      <Button onClick = {(e) => {
                        if(editing){
                          window.alert("Save all items first!")
                          e.preventDefault()
                      ...
                      <Button type="submit" className='mt-2' onClick={
                        (e) => {
                          ...
                          else{updateMessage? handleInvoiceCreation(e) : 
                            window.alert("Net total has not been updated! Check if Net Total is correct.")
                            e.preventDefault()
                            handleNetTotal()
                        }}}>
                          Update Invoice
