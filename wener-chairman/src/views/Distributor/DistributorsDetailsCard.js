        ...
        <Card small className="mb-4 pt-3">
            <CardHeader className="border-bottom ps-4 " style={{ fontSize: '20px' }}>
                ...
                <a target='_blank' href={`https://mkzyadsfkznopwggpnhm.supabase.in/storage/v1/object/public/documents/${distributor.salvage_certificate_path}`}>
                    <button className="btn btn-primary d-block mx-auto mb-3 w-100">View Salvage Certificate</button>
                </a> : 
                <a target='_blank'>
                    <button className="btn btn-secondary d-block mx-auto mb-3 w-100">No Salvage Certificate Available</button>
                </a>
                }
