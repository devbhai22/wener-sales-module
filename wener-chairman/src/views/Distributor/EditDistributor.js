    ...
    useEffect(() => {
        async function fetchData() {
            ...
            if (error) {
                ...
                // path names
                setPhotoName(distributors[0].picture_path ? distributors[0].picture_path.split('.')[0] : '')
                setApplicationName(distributors[0].application_path ? distributors[0].application_path.split('.')[0] : '')
                setDeedName(distributors[0].deed_path ? distributors[0].deed_path.split('.')[0] : '')
                setNidName(distributors[0].nid_path ? distributors[0].nid_path.split('.')[0] : '')
                setTradeLicenseName(distributors[0].trade_license_path ? distributors[0].trade_license_path.split('.')[0] : '')
                setSalvageCertificateName(distributors[0].salvage_certificate_path ? distributors[0].salvage_certificate_path.split('.')[0] : '')
                setBankStatementName(distributors[0].bank_statement_path ? distributors[0].bank_statement_path.split('.')[0] : '')
                setAgreementName(distributors[0].agreement_path ? distributors[0].agreement_path.split('.')[0] : '')
                setChequeName(distributors[0].cheque_path ? distributors[0].cheque_path.split('.')[0] : '')
    ...
    return (
        <Container fluid className="main-content-container px-4 pb-5">
            ...
            <Row noGutters className="page-header py-4">
                <PageTitle sm="12" title="Edit a Dealer" subtitle="Dealers" className="text-sm-left" />
            </Row>
                                ...
                                <Row>
                                    <Col>
                                        <Form>
                                            ...
                                            <FormGroup>
                                                <label htmlFor="feInputName">Upload salvage Certificate</label>
                                                <div className="custom-file">
                                                    <input
                                                        type="file"
                                                        accept=".png,.jpg,.pdf"
                                            ...
                                            <Button type="submit" className='mb-2' onClick={handleClick}>Update Dealer</Button>
                                        </Form>
                                    </Col>
                                </Row>
                            </ListGroupItem>
